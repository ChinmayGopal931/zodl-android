...
How to keep Zapp (`zodl-android-fork`) secure by tracking security-relevant changes
...
```
zodl-android (upstream)          zodl-android-fork (Zapp)
========================         ========================
...
cp ../zodl-android/path/to/file.kt ../zodl-android-fork/path/to/file.kt
...
diff ../zodl-android-fork/path/to/file.kt /tmp/upstream_file.kt
