...
This file covers all the store listing texts for Zapp's presence in the Google Play Store.
...
Zapp is a Zcash wallet that keeps your transaction and message history private.

### Full description

Zapp is a Zcash wallet that keeps your transaction and message history private.

Built for privacy-first financial sovereignty, Zapp is the easiest way to use $ZEC.

Why use the Zapp Zcash wallet?
* You can send and receive ZEC and private memos.
