...
object KnownContractErrors {
    data class Entry(val name: String, val message: String)

    private val ENTRIES: Map<Selector4, Entry> = mapOf(
        ...
        Selector4.fromHex("0x071ea33c") to Entry("USER_HAS_NO_REPUTATION", "Kindly do ZK social verifications and increase your limits to place more orders"),
        Selector4.fromHex("0x074a6991") to Entry("REWARD_PERCENTAGE_TOO_HIGH", "Reward percentage is too high"),
        Selector4.fromHex("0x07a2454f") to Entry("DISPUTE_TIME_NOT_REACHED", "Dispute can only be raised after 30 minutes of order placement"),
        ...
        Selector4.fromHex("0x302c5138") to Entry("CANNOT_CLAIM_REVENUE_FOR_CURRENT_MONTH", "Cannot claim revenue for the current month"),
        ...
        Selector4.fromHex("0x69470b13") to Entry("USERNAME_ALREADY_VERIFIED", "The social media account's username is already verified"),
        ...
        Selector4.fromHex("0x6d4c3f9e") to Entry("ONGOING_ORDER_ON_PAYMENT_CHANNEL", "There is an ongoing order on this payment channel"),
        Selector4.fromHex("0x703cde0a") to Entry("ADDITIONAL_STAKE_NOT_ALLOWED", "Additional stake is not allowed"),
        Selector4.fromHex("0x70d753bd") to Entry("MERCHANT_NOT_FULLFILLED_ELIGIBILITY_THRESHOLD", "Merchant has not fulfilled eligibility threshold"),
        ...
        Selector4.fromHex("0x8f90a426") to Entry("AGGREGATE_DELEGATION_EXCEEDS_TOTAL_STAKED", "Aggregate delegation exceeds total staked"),
        ...
        Selector4.fromHex("0xb28c3e29") to Entry("DISPUTE_TIME_EXPIRED", "Dispute can only be raised after 24 hours of order placement"),
