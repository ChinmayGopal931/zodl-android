...
data class P2pNetworkConfig(
    ...
    // same address on every chain, so these default the same for sepolia and mainnet.
...
object P2pNetworks {
    ...
    // ERC-4337 v0.6: thirdweb's bundler-supported EntryPoint (also p2p.me's) and the prebuilt
    // AccountFactory, both pre-deployed at one address on all chains. We deploy nothing.
